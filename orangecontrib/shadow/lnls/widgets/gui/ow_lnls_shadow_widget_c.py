...
class LNLSShadowWidgetC(widget.OWWidget):
    ...
    def __init__(self, show_automatic_box=True):
        ...
        self.general_options_box = gui.widgetBox(self.controlArea, "General Options", addSpace=False, orientation="horizontal")
        self.general_options_box.setFixedHeight(70)
    ...
    def fixWeirdShadowBug(self):
        if not LNLSShadowWidgetC.is_weird_shadow_bug_fixed:
            try:
                xraylib.Refractive_Index_Re("LaB6", 10000, 4)
            except:
                pass

            LNLSShadowWidgetC.is_weird_shadow_bug_fixed = True
